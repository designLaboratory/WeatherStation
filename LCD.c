...
const uint32 *LCD_TO_PORT[60] =
 {
    (uint32 *) &PORTB->PCR[0],  //LCD_P00
    (uint32 *) &PORTB->PCR[1],  //LCD_P01
    (uint32 *) &PORTB->PCR[2],  //LCD_P02
    (uint32 *) &PORTB->PCR[3],  //LCD_P03
    (uint32 *) &PORTC->PCR[20],  //LCD_P04
    (uint32 *) &PORTC->PCR[21],  //LCD_P05
    //(uint32 *) &PORTC->PCR22,  //LCD_P06
    (uint32 *) &PORTB->PCR[0],  //LCD_P00  test
    
    (uint32 *) &PORTB->PCR[7],  //LCD_P07
    (uint32 *) &PORTB->PCR[8],  //LCD_P08
    (uint32 *) &PORTB->PCR[9],  //LCD_P09
    (uint32 *) &PORTB->PCR[10],  //LCD_P10
    (uint32 *) &PORTB->PCR[11],  //LCD_P11
    (uint32 *) &PORTB->PCR[16],  //LCD_P12
    (uint32 *) &PORTB->PCR[17],  //LCD_P13
    (uint32 *) &PORTB->PCR[18],  //LCD_P14
    (uint32 *) &PORTB->PCR[19],  //LCD_P15
    (uint32 *) &PORTB->PCR[20],  //LCD_P16
    (uint32 *) &PORTB->PCR[21],  //LCD_P17
    (uint32 *) &PORTB->PCR[22],  //LCD_P18
    (uint32 *) &PORTB->PCR[23],  //LCD_P19
    (uint32 *) &PORTC->PCR[0],  //LCD_P20
    (uint32 *) &PORTC->PCR[1],  //LCD_P21
    (uint32 *) &PORTC->PCR[2],  //LCD_P22
    (uint32 *) &PORTC->PCR[3],  //LCD_P23
    (uint32 *) &PORTC->PCR[4],  //LCD_P24
    (uint32 *) &PORTC->PCR[5],  //LCD_P25
    (uint32 *) &PORTC->PCR[6],  //LCD_P26
    (uint32 *) &PORTC->PCR[7],  //LCD_P27
    (uint32 *) &PORTC->PCR[8],  //LCD_P28
    (uint32 *) &PORTC->PCR[9],  //LCD_P29
    (uint32 *) &PORTC->PCR[10],  //LCD_P30
    (uint32 *) &PORTC->PCR[11],  //LCD_P31
    (uint32 *) &PORTC->PCR[12],  //LCD_P32
    (uint32 *) &PORTC->PCR[13],  //LCD_P33
    (uint32 *) &PORTC->PCR[16],  //LCD_P36
    (uint32 *) &PORTC->PCR[17],  //LCD_P37
    (uint32 *) &PORTC->PCR[18],  //LCD_P38
    (uint32 *) &PORTC->PCR[23],  //LCD_P39
    (uint32 *) &PORTD->PCR[0],  //LCD_P40
    (uint32 *) &PORTD->PCR[1],  //LCD_P41
    (uint32 *) &PORTD->PCR[2],  //LCD_P42
    (uint32 *) &PORTD->PCR[3],  //LCD_P43
    (uint32 *) &PORTD->PCR[4],  //LCD_P44
    (uint32 *) &PORTD->PCR[5],  //LCD_P45
    (uint32 *) &PORTD->PCR[6],  //LCD_P46
    (uint32 *) &PORTD->PCR[7],  //LCD_P47
    (uint32 *) &PORTE->PCR[0],  //LCD_P48
    (uint32 *) &PORTE->PCR[1],  //LCD_P49
    (uint32 *) &PORTE->PCR[2],  //LCD_P50
    (uint32 *) &PORTE->PCR[3],  //LCD_P51
    (uint32 *) &PORTE->PCR[4],  //LCD_P52
    (uint32 *) &PORTE->PCR[5],  //LCD_P53
    (uint32 *) &PORTE->PCR[6],  //LCD_P54
    (uint32 *) &PORTE->PCR[16],  //LCD_P55
    (uint32 *) &PORTE->PCR[17],  //LCD_P56
    (uint32 *) &PORTE->PCR[18],  //LCD_P57
    (uint32 *) &PORTE->PCR[19],  //LCD_P58
    (uint32 *) &PORTE->PCR[20],  //LCD_P59
    (uint32 *) &PORTE->PCR[21],  //LCD_P60
